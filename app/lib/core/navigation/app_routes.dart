...
const appRoutes = <AppRoute>[
  AppRoute(title: 'Dashboard', path: '/', icon: Icons.dashboard, group: 'Overview'),
  ...
  AppRoute(title: 'Returns & Refunds', path: '/sales/returns', icon: Icons.assignment_return, group: 'Sales'),

  AppRoute(title: 'Suppliers', path: '/purchasing/suppliers', icon: Icons.local_shipping, group: 'Purchasing'),
  AppRoute(title: 'Purchase Orders', path: '/purchasing/orders', icon: Icons.assignment, group: 'Purchasing'),
  ...
  AppRoute(title: 'Product Import', path: '/inventory/import', icon: Icons.file_upload, group: 'Inventory'),
  AppRoute(title: 'Warehouses', path: '/inventory/warehouses', icon: Icons.warehouse, group: 'Inventory'),
  AppRoute(title: 'Stock Balances', path: '/inventory/balances', icon: Icons.bar_chart, group: 'Inventory'),
  AppRoute(title: 'Stock Movements', path: '/inventory/movements', icon: Icons.swap_horiz, group: 'Inventory'),
  AppRoute(title: 'Adjustments', path: '/inventory/adjustments', icon: Icons.tune, group: 'Inventory'),
  AppRoute(title: 'Reorder Levels', path: '/inventory/reorder', icon: Icons.warning, group: 'Inventory'),

  AppRoute(title: 'Ledger', path: '/finance/ledger', icon: Icons.account_balance, group: 'Finance'),
  AppRoute(title: 'Chart of Accounts', path: '/finance/accounts', icon: Icons.account_tree, group: 'Finance'),
  ...
  AppRoute(title: 'File Manager', path: '/operations/files', icon: Icons.folder, group: 'Operations'),
  AppRoute(title: 'Backups', path: '/operations/backups', icon: Icons.backup, group: 'Operations'),
  AppRoute(title: 'Company Profile', path: '/operations/company', icon: Icons.business, group: 'Operations'),
  AppRoute(title: 'Exports', path: '/operations/exports', icon: Icons.download, group: 'Operations'),

  AppRoute(title: 'Users', path: '/admin/users', icon: Icons.person, group: 'Admin'),
  AppRoute(title: 'Roles & Permissions', path: '/admin/roles', icon: Icons.security, group: 'Admin'),

  AppRoute(title: 'Settings', path: '/settings', icon: Icons.settings, group: 'System'),
];
